      ...
      return (
        ...
        function(modules) {
          ...
          function(module2, exports2, __webpack_require__) {
            ...
            exports2.FilterXSS = FilterXSS;
            for (var i in DEFAULT) exports2[i] = DEFAULT[i];
            for (var i in parser) exports2[i] = parser[i];
            ...
            var containervue_type_script_lang_js = {
              ...
              methods: {
                ...
                handleToolbarWrapperResize: function handleToolbarWrapperResize() {
                  ...
                  if (toolbarWrapper2) this.toolbarHeight = toolbarWrapper2.offsetHeight;
                },
